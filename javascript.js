...
let divsToClearList = ['.meme-content', '.joke-content', '.quote-content', '.riddle-content'];
...
function showJoke()
{
   ...
   jokeDiv.appendChild(newParagraph);
}
function showQuote()
{
    clearDivs();
    ...
    quoteParagraph.textContent = getRandomQuote.quote;
    authorParagraph.textContent = '- '+getRandomQuote.author;
...
function showRiddle()
{
   ...
   const newRiddleParagraph = document.createElement('p');
   const newAnswerParagraph = document.createElement('p');
   newAnswerParagraph.setAttribute('id','answerRiddle');
   newRiddleParagraph.textContent = randomRiddle.question;
   newAnswerParagraph.textContent = randomRiddle.answer;
   newAnswerParagraph.style.visibility = 'hidden';
   riddleDiv.appendChild(newRiddleParagraph);
   riddleDiv.appendChild(newAnswerParagraph);
}
